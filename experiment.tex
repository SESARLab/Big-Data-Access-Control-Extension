...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}[scale=0.7]
    ...
    \node[draw, circle] (s2) at (3,0) {$\sii{2}$};
    \node[draw, circle] (s3) at (3,-1.7) {$\sii{3}$};

    \node[draw, circle] (s11) at (5,1.7) {$\sii{1}$};
    \node[draw, circle] (s12) at (5,0) {$\sii{2}$};
    \node[draw, circle] (s13) at (5,-1.7) {$\sii{3}$};

    \node[draw, circle] (s21) at (7,1.7) {$\sii{1}$};
    \node[draw, circle] (s22) at (7,0) {$\sii{2}$};
    \node[draw, circle] (s23) at (7,-1.7) {$\sii{3}$};

    \node[draw, circle] (s31) at (9,1.7) {$\sii{1}$};
    \node[draw, circle] (s32) at (9,0) {$\sii{2}$};
    \node[draw, circle] (s33) at (9,-1.7) {$\sii{3}$};
