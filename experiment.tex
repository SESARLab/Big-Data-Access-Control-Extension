...
%     \caption{Services operating on the 0.33 to 0.8 data pruning range.}
...
%     \caption{Services operating on the 0.33 to 0.5 data pruning range.}
%     \label{fig:second}
%   \end{subfigure}
%   \hfill % adds horizontal space between the figures
...
%     \caption{Services operating on the 0.33 to 1 data pruning range.}
%     \label{fig:third}
%   \end{subfigure}
