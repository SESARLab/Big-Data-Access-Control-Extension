...
\begin{description}
  ...
  \item[User,] executing an analytics pipeline on the data.  \textcolor{red}{ We assume the user is authorized to perform this operation, either as the data owner or as a data processor with the owner's consent.}
