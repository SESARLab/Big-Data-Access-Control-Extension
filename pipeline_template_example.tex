...
% 4° NODO %
\hl{IL PARAGRAFO CHE SEGUE E' SBAGLIATO?}
...
% 5° NODO %
\hl{I LIVELLI DI ANONIMIZZAZIONI NON SONO CONSISTENTI CON TABELLA 2}
The fourth stage consists of vertex \vi{6}, managing data storage. Data protection annotation \myLambda(\vi{6}) refers to policies \p{5} and \p{6}, which apply different data transformations depending on the relation between the dataset and the service region.
