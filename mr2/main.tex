...
{\color{OurColor2} The growing capacity to handle vast amounts of data, combined with a shift in service delivery models, has improved scalability and efficiency in data analytics, particularly in multi-tenant environments. Data, now treated as digital products, are processed through orchestrated service-based data pipelines. However, advancements in data governance techniques have not kept pace, leaving a gap in effectively managing data throughout the pipeline lifecycle. Addressing this, the proposed framework optimizes service selection and composition within data pipelines to maximize data quality while ensuring compliance with data protection requirements, expressed as access control policies. Given the NP-hard nature of the problem, a sliding-window heuristic is introduced and evaluated against exhaustive and baseline approaches. Experimental results show reduced computational overhead with maintained data quality.}
