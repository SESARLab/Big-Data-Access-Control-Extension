...
\begin{table}[ht!]
    ...
    \begin{tabular}{lp{3cm}p{3.5cm}p{3cm}p{3cm}p{2.5cm}}
        \toprule
        \textbf{Tool} & \textbf{Supports Cloud-Edge Continuum in Service-Based Pipelines} & \textbf{Optimizes Service Selection for Data Quality and Protection} & \textbf{Framework-Agnostic for Data Protection} & \textbf{Automatic Tuning of Data Protection by Service Profile} & \textbf{Expressiveness} \\
        \midrule
